...
type BsInstanceController struct {
	AppController
}

// func (this *BsInstanceController) Prepare() {
// 	this.GetUserInfo()
// }

// func (this *BsInstanceController) Get() {
...
// 	stackRequest := httplib.Get(`http://` + CattlePrismHttpHost + `/v2-beta/projects/1a5/instances`)
...
// func (this *BsInstanceController) Put() {

// }

// func (this *BsInstanceController) Post() {

// }

// func (this *BsInstanceController) Delete() {
